...
FEATURES = {
    ...
    "binance_move_1s_pct": ("cross_exchange", "high", lambda s: _nested(s, "cross_exchange", "binance_move_1s_pct")),
    "binance_move_5s_pct": ("cross_exchange", "high", lambda s: _nested(s, "cross_exchange", "binance_move_5s_pct")),
    "okx_move_1s_pct": ("cross_exchange", "high", lambda s: _nested(s, "cross_exchange", "okx_move_1s_pct")),
    "okx_move_5s_pct": ("cross_exchange", "high", lambda s: _nested(s, "cross_exchange", "okx_move_5s_pct")),
    "binance_minus_bybit_move_1s_pct": ("cross_exchange", "high", lambda s: _nested(s, "cross_exchange", "binance_minus_bybit_move_1s_pct")),
    "binance_minus_bybit_move_5s_pct": ("cross_exchange", "high", lambda s: _nested(s, "cross_exchange", "binance_minus_bybit_move_5s_pct")),
    "okx_minus_bybit_move_1s_pct": ("cross_exchange", "high", lambda s: _nested(s, "cross_exchange", "okx_minus_bybit_move_1s_pct")),
    "okx_minus_bybit_move_5s_pct": ("cross_exchange", "high", lambda s: _nested(s, "cross_exchange", "okx_minus_bybit_move_5s_pct")),
