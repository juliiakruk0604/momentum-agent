            ...
            if ranked:
                ...
                for feature in ranked:
                    ...
                    cross = {
                        ...
                        "binance_move_1s_pct": b1,
                        "binance_move_5s_pct": b5,
                        "okx_move_1s_pct": o1,
                        "okx_move_5s_pct": o5,
                        "binance_minus_bybit_move_1s_pct": b1 - y1 if bctx.get("available") else None,
                        "binance_minus_bybit_move_5s_pct": b5 - y5 if bctx.get("available") else None,
                        "okx_minus_bybit_move_1s_pct": o1 - y1 if octx.get("available") else None,
                        "okx_minus_bybit_move_5s_pct": o5 - y5 if octx.get("available") else None,
